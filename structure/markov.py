...
input_file = argv[1] if len(argv) >= 2 else "../nyt_sentences_100k.txt"
...
if __name__ == "__main__":
  for n in range(0, 10):
    ...
    # EXPERIMENT with fixing why "we was" happens (in no gensim version)
    # if  struct[1] != "ROOT_VBD": # nsubj_PRP_left
    #   continue
